...
public class ApplicationWrap
{
	...
	{
		new LuaMethod("add_logMessageReceived", add_logMessageReceived),
		new LuaMethod("remove_logMessageReceived", remove_logMessageReceived),
		new LuaMethod("add_logMessageReceivedThreaded", add_logMessageReceivedThreaded),
		new LuaMethod("remove_logMessageReceivedThreaded", remove_logMessageReceivedThreaded),
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int add_logMessageReceived(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		UnityEngine.Application.LogCallback arg0 = LuaScriptMgr.GetNetObject<UnityEngine.Application.LogCallback>(L, 1);
		Application.logMessageReceived += arg0;
		return 0;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int remove_logMessageReceived(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		UnityEngine.Application.LogCallback arg0 = LuaScriptMgr.GetNetObject<UnityEngine.Application.LogCallback>(L, 1);
		Application.logMessageReceived -= arg0;
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int add_logMessageReceivedThreaded(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		UnityEngine.Application.LogCallback arg0 = LuaScriptMgr.GetNetObject<UnityEngine.Application.LogCallback>(L, 1);
		Application.logMessageReceivedThreaded += arg0;
		return 0;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int remove_logMessageReceivedThreaded(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		UnityEngine.Application.LogCallback arg0 = LuaScriptMgr.GetNetObject<UnityEngine.Application.LogCallback>(L, 1);
		Application.logMessageReceivedThreaded -= arg0;
