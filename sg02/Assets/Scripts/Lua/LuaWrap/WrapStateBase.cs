...
public class WrapStateBase
{
	...
	static int Create(IntPtr L)
	{
		...
		if (count == 0)
		{
			StateBase obj = new StateBase();
			LuaScriptMgr.Push(L, obj);
			return 1;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: StateBase.New");
		}
	...
	{
		LuaScriptMgr.RegisterLib(L, "StateBase", typeof(StateBase), regs, fields, null);
	}
	...
	static int IsInvoking(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: StateBase.IsInvoking");
		}
	...
	static int StartCoroutine(IntPtr L)
	{
		...
		Type[] types0 = {typeof(StateBase), typeof(string)};
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: StateBase.StartCoroutine");
		}
	...
	static int GetComponent(IntPtr L)
	{
		...
		Type[] types0 = {typeof(StateBase), typeof(string)};
		Type[] types1 = {typeof(StateBase), typeof(Type)};
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: StateBase.GetComponent");
		}
	...
	static int GetComponentsInChildren(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: StateBase.GetComponentsInChildren");
		}
	...
	static int GetComponentsInParent(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: StateBase.GetComponentsInParent");
		}
	...
	static int GetComponents(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: StateBase.GetComponents");
		}
	...
	static int SendMessageUpwards(IntPtr L)
	{
		...
		Type[] types1 = {typeof(StateBase), typeof(string), typeof(SendMessageOptions)};
		Type[] types2 = {typeof(StateBase), typeof(string), typeof(object)};
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: StateBase.SendMessageUpwards");
		}
	...
	static int SendMessage(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: StateBase.SendMessage");
		}
	...
	static int BroadcastMessage(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: StateBase.BroadcastMessage");
		}
