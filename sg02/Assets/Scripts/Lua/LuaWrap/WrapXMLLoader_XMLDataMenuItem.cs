...
public class WrapXMLLoader_XMLDataMenuItem
{
	...
	{
		LuaDLL.luaL_error(L, "XMLLoader<XMLDataMenuItem> class does not have a constructor function");
		return 0;
	}
	...
	{
		LuaScriptMgr.Push(L, typeof(XMLLoader<XMLDataMenuItem>));
		return 1;
	}

	public static void Register(IntPtr L)
	{
		LuaScriptMgr.RegisterLib(L, "XMLLoader<XMLDataMenuItem>", typeof(XMLLoader<XMLDataMenuItem>), regs, fields, null);
	}
	...
	static int get_Data(IntPtr L)
	{
		...
		XMLLoader<XMLDataMenuItem> obj = (XMLLoader<XMLDataMenuItem>)o;
