...
public class XMLLoader_XMLDataCityPointsWrap
{
	...
	{
		LuaDLL.luaL_error(L, "XMLLoader<XMLDataCityPoints> class does not have a constructor function");
		return 0;
	}
	...
	{
		LuaScriptMgr.Push(L, typeof(XMLLoader<XMLDataCityPoints>));
		return 1;
	}

	public static void Register(IntPtr L)
	{
		LuaScriptMgr.RegisterLib(L, "XMLLoader<XMLDataCityPoints>", typeof(XMLLoader<XMLDataCityPoints>), regs, fields, null);
	}
	...
	static int get_Data(IntPtr L)
	{
		...
		XMLLoader<XMLDataCityPoints> obj = (XMLLoader<XMLDataCityPoints>)o;
