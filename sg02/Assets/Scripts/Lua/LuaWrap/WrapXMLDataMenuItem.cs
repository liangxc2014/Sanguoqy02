...
public class WrapXMLDataMenuItem
{
	...
	{
		LuaDLL.luaL_error(L, "XMLDataMenuItem class does not have a constructor function");
		return 0;
	}
	...
	{
		LuaScriptMgr.RegisterLib(L, "XMLDataMenuItem", typeof(XMLDataMenuItem), regs, fields, null);
	}
