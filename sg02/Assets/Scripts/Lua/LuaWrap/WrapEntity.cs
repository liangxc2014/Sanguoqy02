...
public class WrapEntity
{
	...
	static int Create(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Entity.New");
		}
	...
	{
		LuaScriptMgr.RegisterLib(L, "Entity", typeof(Entity), regs, fields, null);
	}
	...
	static int CancelInvoke(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Entity.CancelInvoke");
		}
	...
	static int IsInvoking(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Entity.IsInvoking");
		}
	...
	static int StopCoroutine(IntPtr L)
	{
		...
		Type[] types0 = {typeof(Entity), typeof(Coroutine)};
		Type[] types1 = {typeof(Entity), typeof(IEnumerator)};
		Type[] types2 = {typeof(Entity), typeof(string)};
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Entity.StopCoroutine");
		}
	...
	static int GetComponent(IntPtr L)
	{
		...
		Type[] types0 = {typeof(Entity), typeof(string)};
		Type[] types1 = {typeof(Entity), typeof(Type)};
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Entity.GetComponent");
		}
	...
	static int GetComponentsInParent(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Entity.GetComponentsInParent");
		}
	...
	static int SendMessageUpwards(IntPtr L)
	{
		...
		Type[] types1 = {typeof(Entity), typeof(string), typeof(SendMessageOptions)};
		Type[] types2 = {typeof(Entity), typeof(string), typeof(object)};
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Entity.SendMessageUpwards");
		}
	...
	static int SendMessage(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Entity.SendMessage");
		}
	...
	static int BroadcastMessage(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Entity.BroadcastMessage");
		}
