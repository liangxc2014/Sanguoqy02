...
public class WrapMovmentComponent
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "MovmentComponent", typeof(MovmentComponent), regs, fields, null);
	}
	...
	static int IsInvoking(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: MovmentComponent.IsInvoking");
		}
	...
	static int StopCoroutine(IntPtr L)
	{
		...
		Type[] types0 = {typeof(MovmentComponent), typeof(Coroutine)};
		Type[] types1 = {typeof(MovmentComponent), typeof(IEnumerator)};
		Type[] types2 = {typeof(MovmentComponent), typeof(string)};
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: MovmentComponent.StopCoroutine");
		}
	...
	static int GetComponent(IntPtr L)
	{
		...
		Type[] types0 = {typeof(MovmentComponent), typeof(string)};
		Type[] types1 = {typeof(MovmentComponent), typeof(Type)};
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: MovmentComponent.GetComponent");
		}
	...
	static int GetComponentsInChildren(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: MovmentComponent.GetComponentsInChildren");
		}
	...
	static int GetComponentsInParent(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: MovmentComponent.GetComponentsInParent");
		}
	...
	static int GetComponents(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: MovmentComponent.GetComponents");
		}
	...
	static int SendMessageUpwards(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: MovmentComponent.SendMessageUpwards");
		}
	...
	static int SendMessage(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: MovmentComponent.SendMessage");
		}
