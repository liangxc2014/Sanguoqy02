...
public class XMLLoader_XMLDataPathInfoWrap
{
	...
	{
		LuaDLL.luaL_error(L, "XMLLoader<XMLDataPathInfo> class does not have a constructor function");
		return 0;
	}
	...
	{
		LuaScriptMgr.RegisterLib(L, "XMLLoader<XMLDataPathInfo>", typeof(XMLLoader<XMLDataPathInfo>), regs, fields, null);
	}
