...
public class WrapXMLDataPathInfo
{
	...
	{
		LuaDLL.luaL_error(L, "XMLDataPathInfo class does not have a constructor function");
		return 0;
	}
	...
	{
		LuaScriptMgr.RegisterLib(L, "XMLDataPathInfo", typeof(XMLDataPathInfo), regs, fields, null);
	}
