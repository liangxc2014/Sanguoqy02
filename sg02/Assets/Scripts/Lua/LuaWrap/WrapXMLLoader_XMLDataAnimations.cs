...
public class WrapXMLLoader_XMLDataAnimations
{
	...
	{
		LuaDLL.luaL_error(L, "XMLLoader<XMLDataAnimations> class does not have a constructor function");
		return 0;
	}
	...
	{
		LuaScriptMgr.Push(L, typeof(XMLLoader<XMLDataAnimations>));
		return 1;
	}

	public static void Register(IntPtr L)
	{
		LuaScriptMgr.RegisterLib(L, "XMLLoader<XMLDataAnimations>", typeof(XMLLoader<XMLDataAnimations>), regs, fields, null);
	}
	...
	static int get_Data(IntPtr L)
	{
		...
		XMLLoader<XMLDataAnimations> obj = (XMLLoader<XMLDataAnimations>)o;
